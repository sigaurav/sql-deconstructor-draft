...
class SQLDeconstructor:
    ...
    def process_query(self, full_query):
        ...
        _lookup_dict = self.lookup_table_aliases(self.parent_dict['SELECT'], self.parent_dict['FROM'])
        print(_lookup_dict)
    ...
    def identifierlist(self, tokens, parent_key):
        ...
        :param parent_key: Value to identify position of tokens in SQL statement (Ex, FROM, SELECT)
        :return:
        """
    ...
    def parenthesis(self, token, parent_key):
        """
        Method to process values of class sqlparse.sql.Parenthesis
        :param token: token which contains values of sqlparse.sql.IdentifierList
        :param parent_key: Value to identify position of tokens in SQL statement (Ex, FROM, SELECT)
        :return:
        """
